 ...
 * @author DAM1B11
 */
public class PruebaTabs extends javax.swing.JFrame {
    ...
    public PruebaTabs() {
        ...
        anyadirTab(TITULO_PRODUCTOS, new ConsultarCafeterias());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PruebaTabs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PruebaTabs().setVisible(true);
            }
        });
    }
